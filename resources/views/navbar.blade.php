            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav mr-auto float-left">
                        ...
                        <li class="nav-item "><a class="nav-link" href="{{route('create.talent')}}" title="create"><i style="color:orange" class="ficon feather icon-plus-circle"></i></a></li> 
                        @endif
                        
                        <li>
                            <form  action="{{route('searchtalent')}}" method="post">
                            @csrf
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <span style="color:black" class="user-name">{{Auth::user()->name}}</span>
                            </a>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="{{route('home')}}"><i class="feather icon-users"></i><span style="color:white" class="menu-title" data-i18n="Dashboard">Talents</span></a>
                
                @if(Auth::user()->is_admin == 1)
                    <li class=" nav-item"><a href="{{route('create.booker')}}"><i class="feather icon-user"></i><span style="color:white" class="menu-title" data-i18n="Dashboard">Bookers</span></a>
                @endif
                ...
                <li class='nav-item'><a href='#settings'><i class="feather icon-sliders"></i><span style="color:white" class="menu-title" data-i18n="setting">Setting</span></a>
                    <ul>
                        <li class=" nav-item"><a href="{{route('create.category')}}"><i class="feather icon-grid"></i><span style="color:white" class="menu-title" data-i18n="Dashboard">Category</span></a></li>
                        <li class=" nav-item"><a href="{{route('create.utility')}}"><i class="feather icon-sliders"></i><span style="color:white" class="menu-title" data-i18n="Dashboard">Utility</span></a></li>
                    </ul>
                </li>
                @endif
