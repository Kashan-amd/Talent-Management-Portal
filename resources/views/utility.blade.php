                    ...
                    <div class="card-head">
                        ...
                        <div class="card-body border-top-orange border-top-lighten-5">
                            <div class="list-group">
                                <a href="{{route('create.utility')}}" style="background:#ffa87d" class="list-group-item active">All Utilities</a>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <span class="badge badge-primary badge-pill float-right">{{$totalRaces}}</span>
                                    <a href="#">Race</a>
                                </li>  
                                <li class="list-group-item">
                                    <span class="badge badge-primary badge-pill float-right">{{$totalEyes}}</span>
                                    <a href="#">Eye Color</a>
                                </li>
                                <li class="list-group-item">
                                    <span class="badge badge-primary badge-pill float-right">{{$totalHairs}}</span>
                                    <a href="#">Hair Color</a>
                                </li>  
                            </ul>
                        </div>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <section class="contact-form">
                                                                <form method="post" action="{{route('store.race')}}" enctype="multipart/form-data">
                                                                    @csrf
                                                ...
                                                <tbody>
                                                    @foreach($races as $key)
                                                        <tr>  
                                                            <td>{{$key->race}}</td>
                                                            <td>
                                                                <i id="{{$key->id}}" onclick="deleteRace(this.id)" title="Delete" 
                                                                    style="color:red" class="fa fa-trash" aria-hidden="true">
                                                                <!-- </i> 
                                                                |
                                                                <a class="user_dialog" data-toggle="modal" data-target="#editCategory" data-id="" href="{{$key->id}}">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="modal fade" id="AddEyesModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <section class="contact-form">
                                                            <form method="post" action="{{route('store.eyes')}}" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="modal-header">
                                                ...
                                                <tbody>
                                                    @foreach($eyes as $key)
                                                        <tr>  
                                                            <td>{{$key->eye_color}}</td>
                                                            <td>
                                                                <i id="{{$key->id}}" onclick="deleteEyes(this.id)" title="Delete" 
                                                                    style="color:red" class="fa fa-trash" aria-hidden="true">
                                                                <!-- </i> 
                                                                |
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="modal fade" id="AddHairModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <section class="contact-form">
                                                        <form method="post" action="{{route('store.hair')}}" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="modal-header">
                                    ...
                                    <div class="table-responsive">
                                        <table id="" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle text-center">
                                            ...
                                            <tbody>
                                                @foreach($hairs as $key)
                                                    <tr>  
                                                        <td>{{$key->hair_color}}</td>
                                                        <td>
                                                            <i id="{{$key->id}}" onclick="deleteHair(this.id)" title="Delete" 
                                                                style="color:red" class="fa fa-trash" aria-hidden="true">
                                                            <!-- </i> 
                                                            |
                                                            <a class="user_dialog" data-toggle="modal" data-target="#editCategory" data-id="" href="">
