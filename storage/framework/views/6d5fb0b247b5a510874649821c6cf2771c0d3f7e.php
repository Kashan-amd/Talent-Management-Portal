                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
                                            ...
                                            <input id="name" type="text" placeholder="Username" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input placeholder="Confirm Password" id="password-confirm" type="password" class="form-control <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
</html><?php /**PATH D:\Ainigma Dev\model_agency\resources\views/auth/register.blade.php ENDPATH**/ ?>