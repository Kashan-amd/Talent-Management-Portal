                                                 ...
                                                 <tbody>
                                                    @foreach($categories as $key) 
                                                        <tr>  
                                                            ...
                                                            <td>
                                                                <i id="{{$key->id}}" onclick="deleteCategory(this.id)" title="Delete" 
                                                                    style="color:red" class="fa fa-trash" aria-hidden="true">
                                                                </i> 
                                                                |
                                                                <a class="user_dialog" data-toggle="modal" data-target="#editCategory" data-id="{{$key->id}}" href="">
                        ...
                        <div class="card-head">
                            ...
                            <div class="card-body border-top-orange border-top-lighten-5">
                                <div class="list-group">
                                    <a href="{{route('create.booker')}}" style="background:#ffa87d" class="list-group-item active">All Categories</a>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span class="badge badge-primary badge-pill float-right">{{$totalCategories}}</span>
                                        <a href="#">Categories</a>
                                    </li>  
