                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                        ...
                                        <form id="talentform" method="post" action="<?php echo e(route('store.talent')); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            ...
                                            <div class="media mb-2">
                                                <a class="mr-2" href="#">
                                                    <img src="<?php echo e(url('storage/upload/'.$profile->file_name)); ?>" alt="users avatar" class="users-avatar-shadow rounded-circle" height="64" width="64">
                                                </a>
...
<?php echo $__env->make('navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Ainigma Dev\model_agency\resources\views/talent.blade.php ENDPATH**/ ?>