    ...
    <div class="container">
      <div class="row align-items-center justify-content-around">
        ...
        <div class="col-lg-4 text-center">
          ...
          <div>
            <?php $__currentLoopData = $talent->slice(0, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div data-jarallax-element="-50" class="jarallax">
              <h2><?php echo e($key->first_name); ?> <?php echo e($key->last_name); ?></h2>
              <span class="d-inline-block">@ <?php echo e($key->instagram); ?></span> | 
              <span class="d-inline-block"><?php echo e($key->talent_categories->category_name); ?></span>
              <img src="<?php echo e(url('storage/upload/profile/'.$key->file_name)); ?>" alt="Avatar" class="img-fluid my-0 my-lg-5">
            </div>
        ...
        <div class="col-lg-5 mt-5">
          ...
          <div>
          <?php $__currentLoopData = $talent->slice(2, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <h2><?php echo e($key->first_name); ?> <?php echo e($key->last_name); ?></h2>
            
            <span class="d-inline-block">@ <?php echo e($key->instagram); ?></span> <br>
    ...
    <div class="container">
      ...
      <div>
        <div class="owl-4-slider owl-carousel">
            <?php $__currentLoopData = $talent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="product">
                <a href="#" class="d-block">
                <img src="<?php echo e(url('storage/upload/profile/'.$key->file_name)); ?>" alt="Avatar" class="img-fuild">
                </a>
                <div class="text-center text-md-left">
                <h3><?php echo e($key->first_name); ?> <?php echo e($key->last_name); ?></h3>
                <p><?php echo e($key->instagram); ?> | <?php echo e($key->email); ?></p>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
  ...
  <div class="container pb-5 mb-5 border-bottom">
    <div class="row justify-content-around">
      <div class="col-lg-8 mb-4 mb-lg-0">
        ...
        <p class="mt-5"><a href="<?php echo e(route('home')); ?>" target="_blank" class="btn btn-primary">Find Out More</a></p>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Ainigma Dev\model_agency\resources\views/frontend/home.blade.php ENDPATH**/ ?>