  ...
  <nav class="site-nav">
    <div class="container">
      <div class="site-navigation">
        <a href="{{ route('frontend.home') }}" class="logo float-left m-0">Talent Base<span class="text-primary">.</span></a>
        ...
        <ul class="js-clone-nav d-none d-lg-inline-none site-menu">
          ...
          <li class="text-center h5 my-3 py-1 btn btn-primary"><a class="logo text-light" href="{{ route('home') }}" target="_blank">Login / Sign-Up</a></li>
        </ul>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6">
          ...
          <p><a href="{{ route('home') }}" target="_blank" class="btn btn-primary">Sign In</a></p>
        </div>
      </div>
    </div>
  </div>
