                                                 ...
                                                 <tbody>
                                                    <?php $__currentLoopData = $bookers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                                        <tr>  
                                                            <td>
                                                                <div class="media">
                                                                    <!-- <div class="media-left pr-1">
                                                                        ...
                                                                        <img src="<?php echo e(url('storage/upload/'.$key->file_name)); ?>" alt="avatar"><i></i></span>
                                                                    </div> -->
                                                            ...
                                                            <td>
                                                                <?php if($key->can_write == 1): ?>
                                                                    <span class="badge badge-pill badge-danger">Can Read/Write</span>
                                                                <?php elseif($key->can_read == 1): ?>
                                                                    <span class="badge badge-pill badge-info">Can Read</span>
                                                                <?php endif; ?>
                                                            </td>
                                                            <td>
                                                                <i id="<?php echo e($key->id); ?>" onclick="deleteUser(this.id)" title="Delete" 
                                                                style="color:red" class="fa fa-trash-o" aria-hidden="true"></i>
                                                                     |
                                                                <a class="user_dialog" data-toggle="modal" data-target="#editUser" data-id="<?php echo e($key->id); ?>" href="">
                        ...
                        <div class="card-head">
                            ...
                            <div class="card-body border-top-orange border-top-lighten-5">
                                <div class="list-group">
                                    <a href="<?php echo e(route('create.booker')); ?>" style="background:#ffa87d" class="list-group-item active">All Bookers</a>
...
<?php echo $__env->make('navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Ainigma Dev\model_agency\resources\views/booker.blade.php ENDPATH**/ ?>